...
import { Maximize, Minimize, ShieldCheck, Lock, KeyRound, LogOut, FileText } from 'lucide-react';
    ...
    <div className="w-full h-full flex flex-col justify-between bg-[#040a1c] p-3.5 rounded-xl border border-[#1e345e] shadow-xl text-slate-100">
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-2">
          {/* Button: TẠO ĐỀ BẰNG FILE WORD */}
          <button
            onClick={onOpenWordImport}
            className="w-full py-2 px-3 rounded-lg font-bold text-white text-xs tracking-wider uppercase bg-gradient-to-b from-[#0284c7] via-[#0369a1] to-[#075985] hover:brightness-110 active:scale-95 transition-all shadow-md border border-sky-400/60 cursor-pointer flex items-center justify-center gap-1.5"
            title="Tạo đề thi mới bằng file Word (.docx) hoặc PDF"
          >
